...
<form id="form" name="form" method="post" action="change.php">
<h1>Edit Contact</h1>
...
$result = mysql_query("SELECT * FROM Persons WHERE personID=$_POST[id]");
...
<input type="text" name="firstname" onkeyup="validname(this.value)" size="20" value = <?php echo $row['FirstName'] ?>>
<p>Suggestions: <span id="validname"></span></p>

<label>Last Name
<span class="small">Add last name</span>
</label>
<input type="text" name="lastname" onkeyup="validlastname(this.value)" size="20" value = <?php echo $row['LastName'] ?>>
<p>Suggestions: <span id="validlastname"></span></p>

<label>Email
<span class="small">Add a valid address</span>
</label>
<input type="text" name="email" onkeyup="validemail(this.value)" size="20" value = <?php echo $row['Email'] ?>>
...
<input type="text" name="tel" onkeyup="validtel(this.value)" size="20" value = <?php echo $row['Tel'] ?>>
